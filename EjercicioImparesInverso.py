# 1. Cree un script que imprima los numeros impares segun el rango que indique el usuario
...
print(f"Inicio = {inicioU} -- Final = {finalU} --- Numeros impares en Reversa = {resultU}")